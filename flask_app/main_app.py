...
def load_modules_plot(save = False, relevant_data = False, vertical_lines = False):
    ...
    if res is not None:
        ...
        wrist_ts, base_ts = calculate_timestamps(wrist_x_axis, wrist_derivative, base_x_axis, base_derivative)
